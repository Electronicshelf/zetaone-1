"""
Real integration test for ZataOne CompliancePipeline using OCRExtractor.
Uses actual OCR to extract text from an image, no mocking.

Requires: tesseract-ocr, pytesseract, Pillow.
Run with: pytest tests/test_zataone_pipeline_real_ocr.py -v -s
"""
...
def test_zataone_pipeline_real_ocr():
